...
function blob_fixup() {
    ...
    vendor/lib/libmmcamera_ppeiscore.so | vendor/lib/libmmcamera2_stats_modules.so)
        sed -i "s|libgui.so|libfui.so|g" "${2}"
        ;;
    vendor/lib/libmmcamera2_stats_modules.so | vendor/lib/libmpbase.so)
